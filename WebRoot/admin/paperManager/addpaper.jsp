...
<html>
  <head>
    ...
    <title>My JSP 'addpaper' starting page</title>
  ...
  <body>
   ...
   <div>
   		<div>考卷标题：<input type="text" name="title" /></div>
   		<div>
   			<span>开始考试时间：<input type="text" name="begin_time" class="ui_timepicker"/></span>
   			<span>考试时间：<input type="text" name="ptime" /></span>
   			<span>书卷分值：<input type="text" name="score" /></span>
   		</div>
   		<div>
	...
	<div>
		<div>
			...
			<span>每题分值：<input type="text" name="score1" /></span>
		</div>
